...
public class ImpuestoPredial {
	public static void main(String[] args) {
		...
		impuestos.add(new Impuesto(2014, 616000.00, 21976000.00, "25-899-01-00-00-00-0137-0037-9-09-00-0000",
				"01-00-0137-0037-909", 122800.00, 142844.00));
		impuestos.add(new Impuesto(2015, 644350.00, 22635000.00, "25-899-01-00-00-00-0137-0037-9-09-00-0000",
				"01-00-0137-0037-909", 126600.00, 148600.00));

		impuestos.add(new Impuesto(2016, 689455.00, 23314000.00, "25-899-01-00-00-00-0137-0037-9-09-00-0000",
				"01-00-0137-0037-909", 130300.00, 153000.00));

		impuestos.add(new Impuesto(2017, 737717.00, 24013000.00, "25-899-01-00-00-00-0137-0037-9-09-00-0000",
				"01-00-0137-0037-909", 144600.00, 169800.00));
		impuestos.add(new Impuesto(2018, 781242.00, 24733000.00, "25-899-01-00-00-00-0137-0037-9-09-00-0000",
				"01-00-0137-0037-909", 148900.00, 174800.00));
		impuestos.add(new Impuesto(2019, 828116.00, 25475000.00, "25-899-01-00-00-00-0137-0037-9-09-00-0000",
				"01-00-0137-0037-909", 153400.00, 180100.00));
		impuestos.add(new Impuesto(2020, 877803.00, 26239000.00, "25-899-01-00-00-00-0137-0037-9-09-00-0000",
				"01-00-0137-0037-909", 157900.00, 185500.00));
		impuestos.add(new Impuesto(2021, 908526.00, 27026000.00, "25-899-01-00-00-00-0137-0037-9-09-00-0000",
				"01-00-0137-0037-909", 162697.00, 191074.00));

		impuestos.add(new Impuesto(2022, 1160000.00, 27836780.00, "25-899-01-00-00-00-0137-0909-9-00-00-0037",
				"01-00-0137-0037-909", 167577.00, 196806.00));
		impuestos.add(new Impuesto(2023, 1300000.00, 29037000.00, "25-899-01-00-00-00-0137-0909-9-00-00-0037",
				"01-00-0137-0037-909", 174803.00, 205292.00));
		impuestos.add(new Impuesto(2024, 1423500.00, 30347000.00, "25-899-01-00-00-00-0137-0909-9-00-00-0037",
				"01-00-0137-0037-909", 182689.00, 214553.00));
		impuestos.add(new Impuesto(2025, 1500000.00, 93611000.00, "25-899-01-00-00-00-0137-0909-9-00-00-0037",
				"01-00-0137-0037-909", 237496.00, 278920.00));

		Impuesto impuesto = new Impuesto(2025, 0.00, 0.00, "25-899-01-00-00-00-0137-0909-9-00-00-0037",
				"01-00-0137-0037-909", 0.00, 0.00);

		for (int i = 1; i < impuestos.size(); i++) {
			impuesto.SetImpuesto(impuestos.get(i).getSalario(), impuestos.get(i).getAbaluo(),
					impuestos.get(i).getValor(), impuestos.get(i).getValorMax());
...
class Impuesto {
	...
	public Impuesto(int anio, Double salario, Double abaluo, String catastro30, String catastro, Double valor,
			Double valorMax) {
		this.anio = anio;
	...
	public String calculos(Impuesto impuesto) {
		...
		text = text + "\t" + formato("SALARIO $", salario) + " - " + formato("$", salarioResta) + " - "
				+ formato("%", salarioPorcentaje) + "\n";
		text = text + "\t" + formato("ABALUO $", abaluo) + " - " + formato("$", abaluoResta) + " - "
				+ formato("%", porcentaje(impuesto.getAbaluo(), abaluo)) + "\n";
		text = text + "\t" + formato("VALOR MIN $", valor) + " - " + formato("$", valorResta) + " - "
				+ formato("%", porcentaje(impuesto.getValor(), valor)) + " - "
				+ formato("%", porcentajeBase(abaluo, valor)) + "\n";
		text = text + "\t" + formato("VALOR MAX $", valorMax) + " - " + formato("$", valorMax - impuesto.getValorMax())
				+ " - " + formato("%", porcentaje(impuesto.getValorMax(), valorMax)) + " - "
