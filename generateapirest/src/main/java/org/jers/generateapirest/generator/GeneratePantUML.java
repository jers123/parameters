...
public class GeneratePantUML {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * clasess.add(SystemConstants.class); clasess.add(Constants.class);
		 * 
		 * clasess.add(SwaggerConfig.class);
		 * 
		 * clasess.add(ApiExceptionHandler.class);
		 * 
		 * clasess.add(ReplyMessage.class); clasess.add(ReplyMessageSimple.class);
		 * 
		 * clasess.add(Dto.class); clasess.add(RestApi.class);
		 * 
		 ...
		 * clasess.add(DocumentTypeOutputDTO.class); clasess.add(GenderCreateDTO.class);
		 * clasess.add(GenderUpdateDTO.class); clasess.add(GenderOutputDTO.class);
		 * clasess.add(SectorCreateDTO.class); clasess.add(SectorUpdateDTO.class);
		 ...
		 * 
		 * clasess.add(BaseEntity.class); clasess.add(CivilStatus.class);
		 * clasess.add(DocumentType.class); clasess.add(Gender.class);
		 * clasess.add(Sector.class); clasess.add(TelephoneType.class);
		 * 
		 * clasess.add(IBaseRepository.class);
		 * clasess.add(ICivilStatusRepository.class);
		 * clasess.add(IDocumentTypeRepository.class);
		 * clasess.add(IGenderRepository.class); clasess.add(ISectorRepository.class);
		 * clasess.add(ITelephoneTypeRepository.class);
		 * 
		 * clasess.add(IMapper.class); clasess.add(CivilStatusMapper.class);
		 * clasess.add(DocumentTypeMapper.class); clasess.add(GenderMapper.class);
		 * clasess.add(SectorMapper.class); clasess.add(TelephoneTypeMapper.class);
		 * 
		 * clasess.add(IBaseService.class); clasess.add(IDocumentTypeService.class);
		 * clasess.add(CivilStatusService.class);
		 * clasess.add(DocumentTypeService.class); clasess.add(GenderService.class);
		 * clasess.add(SectorService.class); clasess.add(TelephoneTypeService.class);
		 * 
		 ...
		 * clasess.add(GenderController.class); clasess.add(SectorController.class);
	...
	private static String getMethods(Class<?> cls) {
		...
		for (Method method : methods) {
			if (cls.isEnum() && (method.getName().equals("$VALUES") || method.getName().equals("values")
					|| method.getName().equals("alueOf") || method.getName().equals("$values"))) {
				plantUML = plantUML + "";
			} else {
				if (cls.isInterface()) {
					plantUML = plantUML + "~";
	...
	private static String typeSpecial(ParameterizedType listType) {
		 ...
		 * typeArgument.getClass().componentType()); System.out.println("Descriptor - "
		 * + typeArgument.getClass().descriptorString());
		 * System.out.println("Canonical name - " +
		 * typeArgument.getClass().getCanonicalName());
		 * System.out.println("Array type - " + typeArgument.getClass().arrayType());
		 * System.out.println("Super class - " +
		 * typeArgument.getClass().getGenericSuperclass()); }
		 */
